...
#include "field.h" // 앞서 작성한 FieldElement 헤더
...
public:
    ...
    static std::vector<Polynomial> calculate_lagrange_polynomials(const std::vector<FieldElement>& x_values);

    static Polynomial interpolate_poly_lagrange(const std::vector<FieldElement>& y_values,
                                                const std::vector<Polynomial>& lagrange_polys);

    static Polynomial interpolate_poly(const std::vector<FieldElement>& x_values,
